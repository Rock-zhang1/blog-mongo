/*! Phaser v1.1.5 | (c) 2013 Photon Storm Ltd. */ ! function (a, b) {
    ...
    b.WebGLRenderGroup.prototype.handleFilterBlock = function (a, c) {
        ...
        addDefaultImage: function () {
            var a = new Image;
            a.src = "/public/images/assets/bird.png", this._images.__default = {
                url: null,
                data: a,
                spriteSheet: !1
        ...
        addMissingImage: function () {
            var a = new Image;
            a.src = "/public/images/assets/pipe.png", this._images.__missing = {
                url: null,
                data: a,
                spriteSheet: !1
    ...
    var f = function () {
        ...
        function g(a, b, c, d, e, g) {
            ...
            if (g) {
                ...
                else if (g.bInA = !1, h[1] > i[1]) l = h[0] - i[1], g.aInB = !1;
                else {
                    var m = h[1] - i[0],
                        o = i[1] - h[0];
                    l = o > m ? m : -o
    ...
    return c.Physics = {}, c.Physics.Arcade = function (a) {
        ...
        collideSpriteVsTilemapLayer: function (a, b, c, d, e) {
            if (this._mapData = b.getTiles(a.body.left, a.body.top, a.body.width, a.body.height, !0), 0 !== this._mapData.length)
                if (this._mapData.length > 1) this.separateTiles(a.body, this._mapData);
                else {
                    var f = 0;
        ...
        do
            if (a.visible || d)
                if (a.renderable && 0 !== a.alpha) {
                    ...
                    else if (a instanceof b.FilterBlock)
                        if (a.open) {
                            this.context.save();
                            var f = a.mask.alpha,
                                g = a.mask.worldTransform;
